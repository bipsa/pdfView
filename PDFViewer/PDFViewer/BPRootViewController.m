...
@property (readonly, strong, nonatomic) BPModelController *modelController;
@end
...
- (void)viewDidLoad
{
    ...
    BPDataViewController *startingViewController = [self.modelController viewControllerAtIndex:0 storyboard:self.storyboard];
...
- (BPModelController *)modelController
{
     // Return the model controller object, creating it if necessary.
     // In more complex implementations, the model controller may be passed to the view controller.
    if (!_modelController) {
        _modelController = [[BPModelController alloc] init];
    }
